...
def send_message(data: Data) -> tuple[list[Messages], int]:
    ...
    while True:
        ...
        with Live(console=data.console, refresh_per_second=12, vertical_overflow="visible") as live:
            live.update(Columns([spinner, '[bold color(140)] Thinking...[/bold color(140)]']))
